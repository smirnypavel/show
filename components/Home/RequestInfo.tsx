  ...
  return (
    <div className={styles.container}>
      ...
      <p className={styles.text}>
        ...
        сайту Wechirka для того щоб ввести код верифікації
      </p>
      <p className={styles.text}>
        <span className={styles.textNumber}>5.</span> Після реєстрації Вам у
        ЧАТ-БОТ прийде код для верифікації. Тепер Вам потрібно повернутись до
      ...
      <p className={styles.text}>
        ...
        відправили код, Ваш запит відразу надішлется тілки тим віконавцям яких
        Ви шукаєте
      </p>
      <h4 className={styles.bottomTitle}>
        Я Вас вітаю тепер вам залішілось тільки зачекати коли до Вас в ЧАТ-БОТ
